export const dialogueFlow = [
    ...
    { id: 6, message: "How many meals do you eat daily?", next: 7 },
    { id: 7, message: "How often do you snack in a day? Any specific cravings?", next: 8 },
    { id: 8, message: "Any foods you can't eat/don't like?", next: 9 },
    { id: 9, message: "How much water do you drink in a day?", next: 10 },
    { id: 10, message: "Lastly, share your greatest challenge to eating healthy.", next: null },
  ];